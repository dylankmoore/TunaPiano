...
public class TunaPianoDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Song>().HasData(new Song[]
         {
             new Song {Id = 1, Title = "Blue Bayou", ArtistId = 1, Album = "Simple Dreams", Length = "3:57"},
             new Song {Id = 2, Title = "Western Wind", ArtistId = 2, Album = "The Loneliest Time", Length = "3:46"},
             new Song {Id = 3, Title = "The Big Sky", ArtistId = 3, Album = "Hounds of Love", Length = "4:41"},
             new Song {Id = 4, Title = "9 to 5", ArtistId = 4, Album = "9 to 5 and Odd Jobs", Length = "2:43"},
             new Song {Id = 5, Title = "Ex-Factor", ArtistId = 5, Album = "The Miseducation of Lauryn Hill", Length = "5:27"},
        });
